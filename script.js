  ...
  transactions.forEach((transaction, index) => {
    ...
    listItem.innerHTML = `
      <div class="transaction-description">
        ...
        <p class="transaction-timestamp"style= font-size:10px;>${transaction.timestamp.toLocaleString()}</p>
  ...
  expenses.forEach((expense, index) => {
    ...
    listItem.innerHTML = `
      <div class="transaction-description">
        ...
        <p class="transaction-timestamp" style= font-size:10px;>${expense.timestamp.toLocaleString()}</p>
